...
`D:\Project\MedSupplyOps` 的 commit `bb62bc226877431de42de4bcc8e1558854e60cc7`；先確認
...
強制 Host 先建起來（`_ = _factory.Services;`）。commit `1357405`。
...
`3ccf72e5d0aefc08440e8ba97be33dc68f3e6559`；開工前 `git status --short` 無輸出，
最近三筆歷史含 `d7c5f14`。在 repo 外建立本機 clone
