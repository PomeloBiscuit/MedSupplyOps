...
- **FR-104** 品項條碼與掃描入庫：品項可設定選填且有值時唯一的條碼；品項清單顯示條碼，
  ...
  「這個條碼沒有對應的品項」，且不得清除其他已填欄位。GS1 的 YY 年份固定以 50 為世紀樞紐：
  00～49 解為 2000～2049、50～99 解為 1950～1999，不依執行當下年份改變。
